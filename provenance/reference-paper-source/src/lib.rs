//! Research implementation of Profile A LR-DAS and a source-compressed product code.
//!
...
//! No network, global decoder, Profile B, or production security claim is provided.
#![forbid(unsafe_code)]
#![warn(missing_docs)]
